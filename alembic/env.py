...
# Python ищет по умолчанию в виртуальном окружении
from repo.db import SQLALCHEMY_DATABASE_URL
...
target_metadata = Base.metadata     # Позволит нам делать авто-миграции !
